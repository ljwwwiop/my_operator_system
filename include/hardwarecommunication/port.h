...
namespace myos{
    namespace hardwarecommunication
    {
        ...
        public:
            ...
            virtual void Write(myos::common::uint8_t data); // 一个字节的写入 , 并且实现多态了
        ...
        public:
            ...
            virtual void Write(myos::common::uint16_t data); // 一个字节的写入
        ...
        public:
            ...
            virtual void Write(myos::common::uint32_t data); // 一个字节的写入
        ...
        public:
            ...
            virtual void Write(myos::common::uint8_t data); // 一个字节的写入 , 并且实现多态了
        protected:
            static inline void WriteSlow(myos::common::uint16_t _port,myos::common::uint8_t _data)
            {
