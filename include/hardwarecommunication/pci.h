...
namespace myos{
    ...
    namespace hardwarecommunication{
        ...
        class PeripheralComponentInterconnectControllor{
        public:
            PeripheralComponentInterconnectControllor();
            ~PeripheralComponentInterconnectControllor();

            myos::common::uint32_t Read(myos::common::uint8_t bus,
                myos::common::uint8_t device,
                myos::common::uint8_t functions,
            ...
            myos::drivers::Driver* GetDriver(PeripheralComponentInterconnectDescriptor dev,myos::hardwarecommunication::InterruptManager* interrupts);

            PeripheralComponentInterconnectDescriptor GetDeviceDescriptor(myos::common::uint8_t bus,myos::common::uint8_t device,myos::common::uint8_t function);

            BaseAddressRegister GetBaseAddressRegister(myos::common::uint8_t bus,myos::common::uint8_t device,myos::common::uint8_t function,myos::common::uint8_t bar);
        private:
            Port32Bit dataPort;
