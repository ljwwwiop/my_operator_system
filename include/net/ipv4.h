...
namespace myos{
    namespace net{
        ...
        public:
            InternetProtocolProvider(EtherFrameProvider* backend,AddressResolutionProtocal* arp, common::uint32_t gatewayIP,common::uint32_t subnetMASK);
